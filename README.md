...
1. **Clone the repository**
   ```bash
   git clone https://github.com/el3ttar3/DSAI-Course-Notebooks.git
   ```

2. **Navigate to a course folder**
   ```bash
   cd DSAI-Course-Notebooks/02-Deep-Learning
   ```

3. **Open in Google Colab** - Click the "Open in Colab" badge in any notebook

4. **Install dependencies** - Each notebook includes its required packages
...
<p align="center">
  <strong>Zewail City of Science and Technology</strong><br/>
  <em>University of Science and Technology</em>
</p>

<p align="center">
  <a href="https://www.zewailcity.edu.eg/">
    <img src="https://img.shields.io/badge/Official_Website-zewailcity.edu.eg-blue?style=for-the-badge" alt="Zewail City"/>
  </a>
</p>

<p align="center">
  Zewail City of Science and Technology is Egypt's national project for scientific renaissance,<br/>
  founded by the late Nobel Laureate Dr. Ahmed Zewail.
</p>
